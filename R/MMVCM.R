...
#' @title Multi-dimensional multi-threshold varying coefficient model (MMVCM)
#'
#' @description Jump detection and coefficient estimation for the multi-dimensional multi-threshold varying coefficient model, which can have an unkown number of multi-dimensional jumps.
#'
